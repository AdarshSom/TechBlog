...
<html>
    <head>
        ...
        <div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v17.0" nonce="KDsv4C0z"></script>
    </head>
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="profile.jsp"><span class="fa fa-bullseye"></span>Code with heart <span class="sr-only">(current)</span></a>
                    </li>
            ...
            <div class="row my-4">
                <div class="col-md-6 offset-md-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <img class="card-img-top my-2"mt src="blog_pics/<%= p.getpPic() %>" alt="Card image cap">
    ...
    <div class="col-md-8">
        <%
            ...
            <p class="user-data-info">has posted on:<%=DateFormat.getDateTimeInstance().format(p.getpDate())%></p>
    </div>
                        ...
                        <div class="card-footer primary-background">
                            ...
                            <div class="card-footer">
                                <div class="fb-comments" data-href="http://localhost:8080/TechBlog/show-blog-page.jsp?post_id=<%=p.getPid()%>" data-width="" data-numposts="5"></div>
                            </div>
                    </div>
                </div>
            </div>
